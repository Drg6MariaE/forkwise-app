...
import OnboardingScreen from "./src/screens/onboarding/OnboardingManager";
...
export default function App() {
  const { token, user, isLoading, isFirstLaunch, checkAppInit } =
    useAuthStore();
  ...
  if (showSplash || isLoading) {
    return (
      ...
      >
        ...
        <Text style={{ fontSize: 30, fontWeight: "bold", color: "#6200ee" }}>
          ForkWise
        </Text>
      </View>
    );
